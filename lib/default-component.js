...
var _functions = require("dbl-components/lib/js/functions");
...
var DefaultComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DefaultComponent, [{
    ...
    value: function render() {
      ...
      var cn = [this.constructor.name, className].join(' ');
...
_defineProperty(DefaultComponent, "defaultProps", {
  className: '',
  style: {}
});
