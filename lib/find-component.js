...
var _navSide = _interopRequireDefault(require("./components/nav-side"));

var _navService = _interopRequireDefault(require("./components/nav-service"));

var _navCards = _interopRequireDefault(require("./components/nav-cards"));

var _navListCards = _interopRequireDefault(require("./components/nav-list-cards"));
...
var _default = function _default() {
  ...
  switch (type) {
    ...
    case 'NavSide':
    case 'nav-side':
      return _navSide["default"];

    case 'NavService':
    case 'nav-service':
      return _navService["default"];

    case 'NavCards':
    case 'nav-cards':
      return _navCards["default"];

    case 'NavListCards':
    case 'nav-list-cards':
      return _navListCards["default"];
