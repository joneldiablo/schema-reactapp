...
var Controller = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Controller, [{
    ...
    value: function components() {
      ...
      var Component = this.props.components[type] || (0, _reactImportedComponent["default"])(function () {
        // use the template string (`...`) because "import" 
        // function not working with variables
        return Promise.resolve("".concat(type || from)).then(function (s) {
    ...
    value: function componentWillMount() {
      (0, _functions.setSchema)(this.props.schema);
    }
  }, {
    key: "pages",
    value: function pages(pageId) {
      ...
      return /*#__PURE__*/_react["default"].createElement(ThisPage, page, content.map(function (item, i) {
        return _typeof(item) === 'object' ? /*#__PURE__*/_react["default"].createElement(ThisSection, _extends({
          key: i
        }, item, {
          Component: _this3.components(item)
        }), Array.isArray(item.content) && item.content.map(function (c, j) {
          return _typeof(c) === 'object' ? /*#__PURE__*/_react["default"].createElement(ThisSection, _extends({
            key: j
          }, c, {
            Component: _this3.components(c)
          })) : c;
        })) : item;
      }));
    }
