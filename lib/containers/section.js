...
var Section = /*#__PURE__*/function (_React$Component) {
  ...
  function Section() {
    ...
    _defineProperty(_assertThisInitialized(_this), "id", "".concat(_this.constructor.name, "-").concat((0, _functions.randomS4)()));
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var cn = new Set(className);
      className = Array.from(cn);
      return /*#__PURE__*/_react["default"].createElement("section", {
        className: className.join(' '),
        id: this.id,
        style: style
      }, /*#__PURE__*/_react["default"].createElement(Component, _extends({}, attributes, {
        sectionId: this.id
      }), children));
    }
  }]);
